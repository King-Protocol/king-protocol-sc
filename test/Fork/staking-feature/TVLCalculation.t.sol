...
contract TVLCalculation is StakingIntegrationBase {
    ...
    function test_TVLExcludesUnregisteredTokens() public {
        ...
        assertApproxEqRel(tvlEthBefore, calculatedTvlEthBefore, 1e15, "TVL calculation should be accurate before attack");
        ...
        assertApproxEqRel(tvlEthAfter, calculatedTvlEthAfter, 1e15, "TVL calculation should still be accurate after attack");
        ...
        assertEq(registeredAssets.length, allRegisteredTokens.length, "totalAssets should still return only registered tokens");
