...
contract ValidateDeployment is Script, Utils {
    ...
    function _validateSEthFiStrategy(address strategyAddr) internal view {
        ...
        require(address(strategy.priceProvider()) == MainnetConstants.PRICE_PROVIDER, "SEthFiStrategy price provider mismatch");
    ...
    function _validateEEigenStrategy(address strategyAddr) internal view {
        ...
        require(address(strategy.priceProvider()) == MainnetConstants.PRICE_PROVIDER, "EEigenStrategy price provider mismatch");
